...
(
    SELECT
        ...
        , ip_address_hash
        , source_loaded_at
    FROM "glamira_analytics"."dbt_brucele16o8_intermediate"."int_checkout_success__order_lines"
)
...
(
    ...
    LEFT JOIN "glamira_analytics"."dbt_brucele16o8_staging"."stg_ip_location_lookup" AS location
        ON order_lines.ip_address = location.ip_address
    LEFT JOIN "glamira_analytics"."dbt_brucele16o8_reference"."store_reference" AS store
